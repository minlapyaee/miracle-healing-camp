  ...
  return (
    <div className="divBooking">
      ...
      <div className="divBooking2">
        ...
        <p>
          Before choosing the time that you are available, please fill out your
          information and we will get back soon to you for more updates and plan
          your appointment.
        </p>
      </div>
      <div className="divBooking3">
        <form>
          ...
          <fieldset className="fstForm2">
            ...
            <input type="radio" name="rdoQ1" id="rdo1Q1" value="yes" onChange={e => console.log(e.target.value)}/>
